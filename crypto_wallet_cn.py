...
class 钱包生成器:
    ...
    def __init__(self, 语言: str = "chinese_simplified"):
        """
        初始化钱包生成器
        
        参数:
            语言: 助记词语言，支持 english, chinese_simplified, chinese_traditional, 
                 french, italian, japanese, korean, spanish
        """
        self.语言 = 语言
        self.助记词工具 = Mnemonic(语言)
    ...
    def 助记词转种子(self, 助记词: str, 密码: str = "") -> bytes:
        ...
        返回:
            种子字节
        """
        return self.助记词工具.to_seed(助记词, 密码)
...
def 选择语言() -> str:
    """选择助记词语言"""
    print("\n===== 选择助记词语言 =====\n")
    print("1. 中文简体 (chinese_simplified)")
    print("2. 中文繁体 (chinese_traditional)")
    print("3. 英文 (english)")
    print("4. 日语 (japanese)")
    print("5. 韩语 (korean)")
    print("6. 法语 (french)")
    print("7. 意大利语 (italian)")
    print("8. 西班牙语 (spanish)")
